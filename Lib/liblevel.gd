...
func load_game():
	...
	if FileAccess.file_exists(Player_data.save_path):
		...
		Player_data.player_attack          = data.get("player_attack", 5)
		Player_data.player_defense         = data.get("player_defense", 5)
		Player_data.player_stamina         = data.get("player_stamina", 5)
		Player_data.player_stealth         = data.get("player_stealth", 5)
		Player_data.player_speed           = data.get("player_speed", 5)
		Player_data.player_precision       = data.get("player_precision", 5)
		Player_data.player_strength        = data.get("player_strength", 5)
		Player_data.player_intelligence    = data.get("player_intelligence", 5)
		Player_data.player_weight_capacity = data.get("player_weight_capacity", 5)
		...
		Player_data.player_attack          = 5
		Player_data.player_defense         = 5
		Player_data.player_stamina         = 5
		Player_data.player_stealth         = 5
		Player_data.player_speed           = 5
		Player_data.player_precision       = 5
		Player_data.player_strength        = 5
		Player_data.player_intelligence    = 5
		Player_data.player_weight_capacity = 5
